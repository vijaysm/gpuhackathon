...
template < typename Device, typename MemoryTraits >
...
template < typename Device, typename MemoryTraits >
KokkosKernelOperator< Device, MemoryTraits >::KokkosKernelOperator( MOABSInt nRows, MOABSInt nCols, MOABSInt nNNZs,
...
template < typename Device, typename MemoryTraits >
void KokkosKernelOperator< Device, MemoryTraits >::CreateOperator( const std::vector< MOABSInt >& vecRow,
...
template < typename Device, typename MemoryTraits >
bool KokkosKernelOperator< Device, MemoryTraits >::PerformVerification( const std::vector< MOABReal >& vecAreasA,
                                                                        const std::vector< MOABReal >& vecAreasB )
{
...
template < typename Device, typename MemoryTraits >
void KokkosKernelOperator< Device, MemoryTraits >::PerformSpMV( int n_remap_iterations )
{
...
template < typename Device, typename MemoryTraits >
void KokkosKernelOperator< Device, MemoryTraits >::PerformSpMVTranspose( int n_remap_iterations )
{
